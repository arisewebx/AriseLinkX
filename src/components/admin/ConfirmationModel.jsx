    ...
    switch (type) {
      case 'delete':
        return {
          ...
          button: 'bg-red-600/20 hover:bg-red-600/30 border-red-500/30 text-red-300',
          text: 'text-red-300'
        };
      case 'promote':
        return {
          ...
          button: 'bg-yellow-600/20 hover:bg-yellow-600/30 border-yellow-500/30 text-yellow-300',
      ...
      case 'unban':
        return {
          ...
          button: 'bg-green-600/20 hover:bg-green-600/30 border-green-500/30 text-green-300',
          text: 'text-green-300'
        };
      default:
        return {
          ...
          button: 'bg-blue-600/20 hover:bg-blue-600/30 border-blue-500/30 text-blue-300',
          text: 'text-blue-300'
        };
    }
  };
      ...
      <div className="bg-gray-900 border border-white/10 rounded-2xl p-8 w-full max-w-md">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {!loading && (
            <Button
              onClick={handleClose}
              className="bg-transparent hover:bg-white/10 p-2 text-gray-400 hover:text-white"
            >
              <X className="w-5 h-5" />
            </Button>
          )}
          ...
          {requiresTypeConfirmation && (
            <div className="mb-6">
              ...
              <Input
                ...
                className="bg-white/5 border-white/10 text-white placeholder-gray-500 focus:border-red-500/50"
                disabled={loading}
              />
              {inputError && (
