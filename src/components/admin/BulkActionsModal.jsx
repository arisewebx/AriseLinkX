...
//           <h3 className="text-xl font-semibold text-white">Bulk Actions</h3>
//           <Button
//             onClick={onClose}
//             disabled={loading}
...
//             onClick={onSelectAll}
//             disabled={loading}
//             className="w-full mb-4 bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 text-white"
//           >
...
//             className="w-full bg-red-600/20 hover:bg-red-600/30 border border-red-500/30 text-white disabled:opacity-50"
//           >
...
//             disabled={selectedUsers.length === 0 || loading}
//             className="w-full bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 text-white disabled:opacity-50"
//           >
...
//             disabled={selectedUsers.length === 0 || loading}
//             className="w-full bg-yellow-600/20 hover:bg-yellow-600/30 border border-yellow-500/30 text-white disabled:opacity-50"
//           >
...
//             disabled={selectedUsers.length === 0 || loading}
//             className="w-full bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 text-white disabled:opacity-50"
//           >
...
//             <UserX className="w-5 h-5 text-yellow-400 mt-0.5" />
//             <div>
...
//             disabled={selectedUsers.length === 0 || loading}
//             className="w-full bg-orange-600/20 hover:bg-orange-600/30 border border-orange-500/30 text-white disabled:opacity-50"
//           >
