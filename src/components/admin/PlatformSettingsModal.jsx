    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white border border-gray-200 rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              <h4 className="text-gray-900 font-semibold mb-4">User Limits & Restrictions</h4>
              <div className="space-y-4">
                <div>
                  <label className="text-gray-600 text-sm block mb-2">Max Links Per User</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-gray-600 text-sm block mb-2">Max URL Length</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-gray-600 text-sm block mb-2">Rate Limit (Links per hour)</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-gray-600 text-sm block mb-2">Min Interval Between Links (seconds)</label>
                  <Input
                    type="number"
            ...
            {/* Link Settings */}
            <div className="bg-gray-50 p-6 rounded-xl">
              <h4 className="text-gray-900 font-semibold mb-4">Link Configuration</h4>
              <div className="space-y-4">
                <div>
                  <label className="text-gray-600 text-sm block mb-2">Default Link Expiry (days, 0 = never)</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-gray-600 text-sm block mb-2">Max Custom URL Length</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-gray-600 text-sm block mb-2">Default Click Limit</label>
                  <Input
                    type="number"
            ...
            {/* API Settings */}
            <div className="bg-gray-50 p-6 rounded-xl">
              <h4 className="text-gray-900 font-semibold mb-4">API Configuration</h4>
              <div className="space-y-4">
                <div>
                  <label className="text-gray-600 text-sm block mb-2">Max API Calls Per Hour</label>
                  <Input
                    type="number"
          ...
          <div className="space-y-6">
            {/* Core Features */}
            <div className="bg-gray-50 p-6 rounded-xl">
              <h4 className="text-gray-900 font-semibold mb-4">Core Features</h4>
            ...
            {/* Advanced Features */}
            <div className="bg-gray-50 p-6 rounded-xl">
              <h4 className="text-gray-900 font-semibold mb-4">Advanced Features</h4>
              <div className="space-y-2">
                <ToggleButton
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              <h4 className="text-gray-900 font-semibold mb-4">Security & Protection</h4>
              <div className="space-y-2">
                <ToggleButton
              ...
              {settings.maintenanceMode && (
                <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-red-600 font-medium">Maintenance Mode Active</span>
                  </div>
        ...
        <div className="mt-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-6 rounded-xl border border-blue-500/20">
          <h4 className="text-gray-900 font-semibold mb-4">Configuration Summary</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-gray-600">Max Links/User:</span>
                <span className="text-gray-900 font-medium">{settings.maxLinksPerUser}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Rate Limit/Hour:</span>
                <span className="text-gray-900 font-medium">{settings.rateLimitPerHour}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">URL Length Limit:</span>
                <span className="text-gray-900 font-medium">{settings.maxUrlLength} chars</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Link Interval:</span>
                <span className="text-gray-900 font-medium">{settings.minLinkInterval}s</span>
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-gray-600">Custom URLs:</span>
                <span className={settings.allowCustomUrls ? "text-green-500" : "text-red-500"}>
                  {settings.allowCustomUrls ? "Enabled" : "Disabled"}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Email Verification:</span>
                <span className={settings.requireEmailVerification ? "text-green-500" : "text-red-500"}>
                  {settings.requireEmailVerification ? "Required" : "Optional"}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Analytics:</span>
                <span className={settings.enableAnalytics ? "text-green-500" : "text-red-500"}>
                  {settings.enableAnalytics ? "Enabled" : "Disabled"}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">QR Codes:</span>
                <span className={settings.enableQRCodes ? "text-green-500" : "text-red-500"}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className={settings.allowGuests ? "text-green-500" : "text-red-500"}>
                  {settings.allowGuests ? "Allowed" : "Disabled"}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">API Access:</span>
                <span className={settings.enableApiAccess ? "text-green-500" : "text-red-500"}>
                  {settings.enableApiAccess ? "Enabled" : "Disabled"}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Spam Protection:</span>
                <span className={settings.enableSpamProtection ? "text-green-500" : "text-red-500"}>
                  {settings.enableSpamProtection ? "Active" : "Inactive"}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Maintenance:</span>
                <span className={settings.maintenanceMode ? "text-red-500" : "text-green-500"}>
        ...
        <div className="flex gap-4 mt-6">
          <Button 
            onClick={handleSave} 
            disabled={isSaving}
            className="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-gray-900 disabled:opacity-50"
          >
          ...
          <Button 
            ...
            className="bg-gray-600/20 hover:bg-gray-600/30 border border-gray-500/30 text-gray-600"
          >
            Reset to Defaults
          </Button>
        </div>
