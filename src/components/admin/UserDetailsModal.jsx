...
//       <div className="bg-white border border-gray-200 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
//         {/* Header */}
...
//           <Button
//             onClick={onClose}
//             className="w-8 h-8 p-0 bg-gray-100 hover:bg-gray-200 border-0"
//           >
//             <X className="w-4 h-4" />
//           </Button>
//         </div>
...
//             <p className="text-gray-900 mt-4">Loading user details...</p>
//           </div>
//         )}
...
//               <p className="text-red-600">Error loading user details: {detailsError.message}</p>
//             </div>
//           </div>
//         )}
...
//                           <div>
//                             <p className="text-2xl font-bold text-gray-900">{stats.avgClicksPerLink}</p>
...
//                           <p className="text-gray-900 font-mono text-xs">{cleanUserId}</p>
//                         </div>
//                       </div>
//                     </CardContent>
//                   </Card>
...
//                   <h3 className="text-xl font-bold text-gray-900">User Links ({urls.length})</h3>
//                   {urls.length === 0 ? (
//                     <p className="text-gray-400">No links created yet.</p>
//                   ) : (
//                     <div className="space-y-3">
//                       {urls.slice(0, 10).map((url) => (
//                         <div key={url.id} className="bg-gray-50 border border-gray-200 rounded-lg p-4">
//                           <div className="flex items-center justify-between">
//                             <div className="flex-1">
//                               <h4 className="text-gray-900 font-medium">{url.title}</h4>
//                               <p className="text-blue-500 text-sm">/{url.short_url}</p>
//                               <p className="text-gray-400 text-xs">{url.original_url}</p>
//                             </div>
//                             <div className="flex items-center gap-4">
//                               <div className="text-right">
//                                 <p className="text-gray-900 font-medium">{url.clickCount || 0} clicks</p>
...
//                                 className="bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-600"
//                               >
...
//               {activeTab === 'activity' && (
//                 <div className="space-y-4">
//                   <h3 className="text-xl font-bold text-gray-900">Recent Activity (Last 30 days)</h3>
//                   {activityLoading ? (
//                     <BarLoader width="100%" color="#8b5cf6" height={3} />
...
//                               <div>
//                                 <p className="text-gray-900 text-sm">Link clicked</p>
//                                 <p className="text-gray-400 text-xs">
...
//               {activeTab === 'actions' && (
//                 <div className="space-y-6">
//                   <h3 className="text-xl font-bold text-gray-900">User Actions</h3>
...
//                             disabled={removeAdminLoading || user.email === 'arisewebx@gmail.com'}
...
//         disabled={unbanLoading || user.email === 'arisewebx@gmail.com'}
...
//         disabled={banLoading || user.email === 'arisewebx@gmail.com'}
...
//                         disabled={deleteLoading || user.email === 'arisewebx@gmail.com'}
//                         className="bg-red-600 hover:bg-red-500"
//                       >
...
//   const isPrimaryAdmin = user?.email === 'arisewebx@gmail.com';
...
//                             <Activity className="w-8 h-8 text-green-500" />
//                             <div>
//                               <p className="text-2xl font-bold text-gray-900">{stats.avgClicksPerLink || 0}</p>
//                               <p className="text-gray-400 text-sm">Avg. Clicks</p>
//                             </div>
//                           </div>
//                         </CardContent>
...
//                                   onClick={() => handleDeleteLink(url.id, url.title)}
//                                   disabled={actionLoading}
//                                   className="bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-600 disabled:opacity-50"
//                                 >
//                                   <Trash2 className="w-4 h-4" />
//                                 </Button>
//                               </div>
...
//                               className="bg-orange-50 hover:bg-orange-100 border border-orange-200 text-orange-700 disabled:opacity-50"
//                             >
...
//                               onClick={handleMakeAdmin}
//                               disabled={actionLoading}
//                               className="bg-yellow-50 hover:bg-yellow-100 border border-yellow-200 text-yellow-700 disabled:opacity-50"
//                             >
...
//                               onClick={handleUnbanUser}
//                               disabled={actionLoading || isPrimaryAdmin}
//                               className="bg-green-50 hover:bg-green-100 border border-green-200 text-green-700 disabled:opacity-50"
//                             >
...
//                               onClick={handleBanUser}
//                               disabled={actionLoading || isPrimaryAdmin}
//                               className="bg-red-50 hover:bg-red-100 border border-red-200 text-red-700 disabled:opacity-50"
//                             >
//                               <UserX className="w-4 h-4 mr-2" />
//                               Ban User
//                             </Button>
...
//             <h2 className="text-xl font-bold text-gray-900">Invalid User ID</h2>
//             <Button
//               onClick={onClose}
//               className="w-8 h-8 p-0 bg-gray-100 hover:bg-gray-200 border-0"
//             >
...
//           </div>
//           <div className="bg-red-50 border border-red-200 rounded-lg p-4">
//             <p className="text-red-600 mb-2">Cannot load user details</p>
...
//                           disabled={actionLoading}
//                           className="bg-blue-50 hover:bg-blue-100 border border-blue-200 text-blue-700 disabled:opacity-50"
//                         >
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
        <div className="bg-white border border-gray-200 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-xl">
          {/* Header */}
          <div className="flex items-center justify-between p-5 border-b border-gray-100">
            <div className="flex items-center gap-3">
              {user?.profilepic ? (
                <img src={user.profilepic} alt={user.name} className="w-12 h-12 rounded-full object-cover border-2 border-gray-200" />
              ) : (
                <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center">
                  <span className="text-lg font-bold text-orange-500">{user?.name?.charAt(0)?.toUpperCase() || <User className="w-5 h-5" />}</span>
                </div>
              )}
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-1">
                  <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${user?.status === 'active' ? 'bg-green-50 text-green-700 border border-green-200' : 'bg-yellow-50 text-yellow-700 border border-yellow-200'}`}>
                    {user?.status === 'active' ? 'Active' : 'Pending'}
                  </span>
                  {user?.app_metadata?.banned && (
                    <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-red-50 text-red-600 border border-red-200">Banned</span>
                  )}
                </div>
              </div>
            </div>
            <button onClick={onClose} disabled={actionLoading} className="text-gray-400 hover:text-gray-600 w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-100">×</button>
          </div>

          {actionLoading && (
            <div className="px-5 py-2.5 bg-orange-50 border-b border-orange-100 flex items-center gap-2">
              <BarLoader width="50px" color="#f97316" height={2} />
              <span className="text-xs text-orange-600">{currentAction}</span>
            </div>
          )}
          {detailsLoading && <div className="p-5"><BarLoader width="100%" color="#f97316" height={2} /><p className="text-sm text-gray-500 mt-3">Loading user details...</p></div>}
          {detailsError && (
            <div className="p-5"><div className="bg-red-50 border border-red-200 rounded-lg p-3"><p className="text-sm text-red-600">Error: {detailsError.message}</p></div></div>
          )}
          ...
          {user && (
            <>
              ...
              <div className="border-b border-gray-100 px-5">
                <div className="flex gap-1">
                  {[
                    ...
                    <button key={tab.id} onClick={() => setActiveTab(tab.id)} disabled={actionLoading}
                      className={`flex items-center gap-1.5 px-3 py-3 text-sm font-medium border-b-2 transition-colors disabled:opacity-50 ${
              ...
              <div className="p-5 max-h-[60vh] overflow-y-auto">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      {[
                        ...
                        { icon: MousePointer, value: stats.totalClicks || 0, label: "Total Clicks" },
                        { icon: Activity, value: stats.avgClicksPerLink || 0, label: "Avg. Clicks" },
                        { icon: Calendar, value: user.last_sign_in_at ? new Date(user.last_sign_in_at).toLocaleDateString() : 'Never', label: "Last Active" },
                      ].map((s) => (
                        <div key={s.label} className="bg-gray-50 border border-gray-100 rounded-xl p-3">
                          <div className="w-7 h-7 bg-orange-50 rounded-lg flex items-center justify-center mb-2">
                    ...
                    {locationStats.totalClicks > 0 && (
                      <div className="bg-gray-50 border border-gray-100 rounded-xl p-4">
                        <h4 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
                          <Globe className="w-4 h-4 text-orange-500" />Location Analytics
                        </h4>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                          {[
                            { label: "Verified", value: locationStats.accurateClicks, color: "text-green-600" },
                            { label: "VPN/Proxy", value: locationStats.vpnClicks, color: "text-amber-500" },
                            { label: "Countries", value: locationStats.uniqueCountries, color: "text-orange-500" },
                            { label: "Cities", value: locationStats.uniqueCities, color: "text-gray-700" },
                          ].map((s) => (
                            <div key={s.label} className="bg-white border border-gray-200 rounded-lg p-2.5 text-center">
                        ...
                        {locationStats.topCountries.length > 0 && (
                          <div className="space-y-1.5">
                            {locationStats.topCountries.map(({ country, count }) => (
                              <div key={country} className="flex items-center justify-between bg-white border border-gray-100 rounded-lg px-3 py-2">
                                <span className="text-sm text-gray-700">{country}</span>
                                <span className="text-sm font-medium text-orange-500">{count} clicks</span>
                              </div>
                            ))}
                          </div>
                        )}
                    ...
                    <div className="bg-gray-50 border border-gray-100 rounded-xl p-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                        {[
                          ...
                          { label: "User ID", value: cleanUserId },
                        ].map((r) => (
                          <div key={r.label}>
                            <p className="text-xs text-gray-400 mb-0.5">{r.label}</p>
                            <p className="text-gray-700 font-mono text-xs break-all">{r.value}</p>
                          </div>
                        ))}
                      </div>
                    </div>
                ...
                {activeTab === 'links' && (
                  <div className="space-y-3">
                    <p className="text-sm font-semibold text-gray-900">User Links ({urls.length})</p>
                    {urls.length === 0 ? (
                      <p className="text-sm text-gray-400">No links created yet.</p>
                    ) : (
                      <>
                        {urls.slice(0, 10).map((url) => {
                            ...
                            <div key={url.id} className="bg-gray-50 border border-gray-100 rounded-lg p-3">
                              <div className="flex items-start justify-between gap-3">
                                <div className="min-w-0 flex-1 space-y-1.5">
                                  <p className="text-sm font-semibold text-gray-900">{url.title || 'Untitled'}</p>
                                  <div className="flex items-center gap-1.5">
                                    <Link2 className="w-3 h-3 text-orange-400 shrink-0" />
                                    <a href={shortLink} target="_blank" rel="noopener noreferrer"
                                      className="text-xs text-orange-500 hover:text-orange-600 hover:underline break-all font-mono">
                                      {shortLink}
                                    </a>
                                  </div>
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                  <div className="text-right">
                                    <p className="text-sm font-semibold text-gray-900">{url.clickCount || 0}</p>
                                    <p className="text-xs text-gray-400">{new Date(url.created_at).toLocaleDateString()}</p>
                                  </div>
                                  <Button size="sm" variant="outline" onClick={(e) => { e.stopPropagation(); if (!actionLoading) handleDeleteLink(url.id, url.title); }}
                                    disabled={actionLoading} className="border-red-200 text-red-500 hover:bg-red-50 h-8 w-8 p-0">
                        ...
                        {urls.length > 10 && <p className="text-xs text-gray-400 text-center">And {urls.length - 10} more links...</p>}
                      </>
                    )}
                  </div>
                )}
                            ...
                            <div key={index} className="bg-gray-50 border border-gray-100 rounded-lg p-3">
                              <div className="flex items-start justify-between gap-3">
                                <div className="flex items-center gap-2">
                                  <MousePointer className="w-3.5 h-3.5 text-orange-500 shrink-0" />
                                  <div>
                                    <p className="text-xs font-medium text-gray-900">Link clicked</p>
                                    <p className="text-xs text-gray-400">{new Date(click.created_at).toLocaleString()}</p>
                                  </div>
                                </div>
                                <div className="flex flex-wrap items-center gap-2 text-xs text-gray-500">
                                  {click.country && <span className="flex items-center gap-1"><Globe className="w-3 h-3" />{click.country}{accuracy === 'likely_accurate' && <CheckCircle className="w-3 h-3 text-green-500" />}{accuracy === 'potential_vpn_proxy' && <AlertTriangle className="w-3 h-3 text-amber-500" />}</span>}
                                  {click.city && <span className="flex items-center gap-1"><MapPin className="w-3 h-3" />{click.city}</span>}
                                  {click.device && <span className="flex items-center gap-1"><Smartphone className="w-3 h-3" />{click.device}</span>}
                                </div>
                              </div>
                            </div>
                          );
                ...
                {activeTab === 'actions' && (
                  <div className="space-y-4">
                    <p className="text-sm font-semibold text-gray-900">User Actions</p>

                    <div className="bg-gray-50 border border-gray-100 rounded-xl p-4 space-y-3">
                      <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wide flex items-center gap-1.5"><Crown className="w-3.5 h-3.5 text-yellow-500" />Admin Privileges</h4>
                      <p className="text-xs text-gray-500">Current: {user.isAdmin ? 'Admin' : 'Regular User'}</p>
                      {user.isAdmin ? (
                        <Button onClick={handleRemoveAdmin} disabled={actionLoading || isPrimaryAdmin} variant="outline" className="border-amber-200 text-amber-600 hover:bg-amber-50 h-9 disabled:opacity-50">
                          <ShieldOff className="w-4 h-4 mr-2" />Remove Admin
                        </Button>
                      ) : (
                        <Button onClick={handleMakeAdmin} disabled={actionLoading} variant="outline" className="border-yellow-200 text-yellow-600 hover:bg-yellow-50 h-9 disabled:opacity-50">
                          <Shield className="w-4 h-4 mr-2" />Make Admin
                        </Button>
                      )}
                      {isPrimaryAdmin && <p className="text-xs text-amber-600">⚠️ Primary admin account cannot be modified.</p>}
                    </div>

                    <div className="bg-gray-50 border border-gray-100 rounded-xl p-4 space-y-3">
                      <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wide flex items-center gap-1.5"><UserX className="w-3.5 h-3.5 text-red-500" />Account Status</h4>
                      <p className="text-xs text-gray-500">Current: {user.app_metadata?.banned ? 'Banned' : 'Active'}</p>
                      {user.app_metadata?.banned ? (
                        <Button onClick={handleUnbanUser} disabled={actionLoading || isPrimaryAdmin} variant="outline" className="border-green-200 text-green-600 hover:bg-green-50 h-9 disabled:opacity-50">
                          <UserX className="w-4 h-4 mr-2" />Unban User
                        </Button>
                      ) : (
                        <Button onClick={handleBanUser} disabled={actionLoading || isPrimaryAdmin} variant="outline" className="border-red-200 text-red-500 hover:bg-red-50 h-9 disabled:opacity-50">
                          <UserX className="w-4 h-4 mr-2" />Ban User
                        </Button>
                      )}
                      {isPrimaryAdmin && <p className="text-xs text-amber-600">⚠️ Primary admin account cannot be banned.</p>}
                    </div>

                    <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-3">
                      <h4 className="text-xs font-semibold text-red-500 uppercase tracking-wide flex items-center gap-1.5"><Trash2 className="w-3.5 h-3.5" />Danger Zone</h4>
                      <p className="text-xs text-red-500">Permanently delete this user and all their data. Cannot be undone.</p>
                      <Button onClick={handleDeleteUser} disabled={actionLoading || isPrimaryAdmin} className="bg-red-500 hover:bg-red-600 text-white h-9 disabled:opacity-50">
                        <Trash2 className="w-4 h-4 mr-2" />Delete User
                      </Button>
                      {isPrimaryAdmin && <p className="text-xs text-red-500">⚠️ Primary admin account cannot be deleted.</p>}
                    </div>
                  </div>
                )}
              </div>
