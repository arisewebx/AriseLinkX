...
// //       <div className="bg-white border border-gray-200 rounded-2xl p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
// //         <div className="flex items-center justify-between mb-6">
// //           <h3 className="text-xl font-semibold text-gray-900 flex items-center gap-3">
// //             <Clock className="w-6 h-6 text-green-500" />
// //             User Activity Monitor
// //           </h3>
// //           <Button onClick={onClose} className="bg-transparent hover:bg-gray-100 p-2">
...
// //                 <span className="text-green-500 font-semibold">{activityData.signupsToday}</span>
// //               </div>
// //               <div className="flex items-center justify-between">
// //                 <span className="text-gray-600">Signups This Week</span>
// //                 <span className="text-blue-500 font-semibold">{activityData.signupsThisWeek}</span>
// //               </div>
// //               <div className="flex items-center justify-between">
...
// //                 <span className="text-yellow-500 font-semibold">{platformStats.activeUsers}</span>
// //               </div>
// //             </div>
// //           </div>
...
// //             <div className="space-y-3">
// //               <div className="flex items-center justify-between">
// //                 <span className="text-gray-600">Links Created Today</span>
// //                 <span className="text-green-500 font-semibold">{activityData.linksCreatedToday}</span>
// //               </div>
// //               <div className="flex items-center justify-between">
// //                 <span className="text-gray-600">Links This Week</span>
// //                 <span className="text-blue-500 font-semibold">{activityData.linksCreatedThisWeek}</span>
// //               </div>
// //               <div className="flex items-center justify-between">
...
// //               </div>
// //               <div className="flex items-center justify-between">
// //                 <span className="text-gray-600">Clicks This Week</span>
...
// //             <div className="text-gray-900 font-semibold">Total Users</div>
// //             <div className="text-blue-600 text-xl font-bold">{platformStats.totalUsers}</div>
// //           </div>
...
// //             <div className="text-gray-900 font-semibold">Total Links</div>
// //             <div className="text-green-600 text-xl font-bold">{platformStats.totalLinks}</div>
// //           </div>
...
// //             <div className="text-gray-900 font-semibold">Total Clicks</div>
...
// //             <div className="text-gray-900 font-semibold">Avg CTR</div>
...
// //         <div className="bg-gray-50 p-6 rounded-xl">
// //           <h4 className="text-gray-900 font-semibold mb-4">Recent Activity Feed</h4>
...
// //                     <div className="text-gray-900 text-sm truncate">{activity.action}</div>
...
//     const activityTypes = [
//       { type: 'login', icon: User, color: 'text-blue-500', bgColor: 'bg-blue-500/20' },
//       { type: 'link_created', icon: Link2, color: 'text-green-500', bgColor: 'bg-green-500/20' },
//       { type: 'link_clicked', icon: MousePointer, color: 'text-purple-400', bgColor: 'bg-purple-500/20' },
//       { type: 'user_banned', icon: Ban, color: 'text-red-500', bgColor: 'bg-red-500/20' },
//       { type: 'user_unbanned', icon: CheckCircle, color: 'text-green-500', bgColor: 'bg-green-500/20' },
//       { type: 'admin_promoted', icon: Shield, color: 'text-yellow-500', bgColor: 'bg-yellow-500/20' },
...
//       { type: 'security_alert', icon: AlertTriangle, color: 'text-red-500', bgColor: 'bg-red-500/20' }
//     ];
...
//   return (
//     <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
//       <div className="bg-white border border-gray-200 rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
//         <div className="flex items-center justify-between mb-6">
//           <h3 className="text-xl font-semibold text-gray-900 flex items-center gap-3">
...
//               className="px-3 py-1 bg-gray-100 border border-gray-200 rounded-lg text-gray-900 text-sm focus:outline-none focus:border-blue-500/50"
//             >
...
//               <div key={activity.id} className="bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition-colors">
...
const UserActivityModal = ({ isOpen, onClose, users }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white border border-gray-200 rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col shadow-xl">
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            <Button onClick={handleExportActivities} disabled={loading} variant="outline" className="border-gray-200 text-gray-700 hover:bg-gray-50 h-9">
        ...
        {/* Filters */}
        <div className="flex flex-wrap gap-3 mb-5 p-3 bg-gray-50 border border-gray-100 rounded-xl">
          <div className="flex items-center gap-2">
            <Filter className="w-4 h-4 text-gray-400" />
            <select value={filter} onChange={(e) => setFilter(e.target.value)}
              className="px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-gray-700 text-sm focus:outline-none focus:border-orange-400">
              <option value="all">All Activities</option>
              <option value="logins">Logins & Registration</option>
          ...
          <span className="text-xs text-gray-400 flex items-center">
            {loading ? <><Loader2 className="w-3.5 h-3.5 animate-spin mr-1" />Loading...</> : `${filteredActivities.length} activities`}
          </span>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            ...
            <div className="space-y-2">
              {filteredActivities.map((activity) => (
                <div key={activity.id} className="bg-gray-50 border border-gray-100 p-3.5 rounded-lg hover:bg-gray-100 transition-colors">
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          ...
                          <div className="flex flex-wrap items-center gap-2 mt-0.5">
                            <span className="text-xs text-gray-400">{activity.user.email}</span>
                            {activity.metadata.clicks && <span className="text-xs text-orange-500">{activity.metadata.clicks} clicks</span>}
                            {activity.metadata.reason && <span className="text-xs text-amber-500">{activity.metadata.reason}</span>}
              ...
              {filteredActivities.length === 0 && !loading && (
                <div className="text-center py-12">
                  <div className="w-11 h-11 mx-auto mb-3 bg-orange-50 rounded-xl flex items-center justify-center">
                    <Activity className="w-5 h-5 text-orange-300" />
                  </div>
                  <p className="text-sm font-medium text-gray-700">No activities found</p>
                  <p className="text-xs text-gray-400 mt-1">No activities match the current filters.</p>
                </div>
              )}
            </div>
          )}
        ...
        {!loading && filteredActivities.length > 0 && (
          <div className="mt-4 pt-4 border-t border-gray-100 grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
            {[
              { label: "Login Events", value: filteredActivities.filter(a => ['login','user_registered'].includes(a.type)).length, color: "text-green-600" },
              { label: "Click Activities", value: filteredActivities.filter(a => a.type === 'link_clicked').length, color: "text-orange-500" },
              { label: "Admin Actions", value: filteredActivities.filter(a => ['admin_promoted','user_banned','user_unbanned'].includes(a.type)).length, color: "text-amber-500" },
              { label: "Security Alerts", value: filteredActivities.filter(a => a.type === 'security_alert').length, color: "text-red-500" },
            ].map((s) => (
